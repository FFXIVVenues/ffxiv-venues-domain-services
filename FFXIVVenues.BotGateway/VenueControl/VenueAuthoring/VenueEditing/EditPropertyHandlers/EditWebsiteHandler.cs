...
public class EditWebsiteHandler(IAuthorizer authorizer, IApiService apiService) : IComponentHandler
{
    public static string Key => "CONTROL_EDIT_WEBSITE";
    ...
    public async Task HandleAsync(ComponentVeniInteractionContext context, string[] args)
    {
        ...
        await context.Session.MoveStateAsync<WebsiteEntrySessionState>(context);
    }
